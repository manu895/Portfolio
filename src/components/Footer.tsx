      ...
      >
        ...
        >
            ...
            <motion.div variants={itemVariants} className="lg:col-span-2">
              ...
              >
                ...
                <p className="text-gray-300 mb-6 leading-relaxed">
                  Sviluppatore Frontend specializzato in React, Next.js e TypeScript. 
          ...
          <motion.div 
            ...
            className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 backdrop-blur-sm border border-white/10 rounded-2xl p-8 mb-12"
          >
            <div className="max-w-md mx-auto text-center">
              ...
              <h4 className="text-2xl font-bold mb-2">Resta Aggiornato</h4>
              <p className="text-gray-300 mb-6">
                Ricevi le ultime novità sui miei progetti e articoli tech
              </p>
              ...
              <form onSubmit={handleSubmit} className="flex gap-3">
                <motion.input
                  ...
                  className="flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300"
                ...
                <motion.button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-xl font-medium transition-all duration-300 disabled:opacity-50 flex items-center gap-2"
            ...
            <div className="flex items-center gap-6 mb-6 md:mb-0">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className={`
                    p-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl
